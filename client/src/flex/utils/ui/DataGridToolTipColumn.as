package flex.utils.ui
{
    ...
    /**
     * Extends DataGridColumn to support a headerToolTip property.
     ...
     * @date July 29th, 2009
     */
    public class DataGridToolTipColumn extends DataGridColumn
    {
        ...
        public function DataGridToolTipColumn(columnName:String = null) {
            super(columnName);
 ...
 */
internal class HeaderRenderer extends DataGridItemRenderer implements IFactory
{
    
    private var column:DataGridToolTipColumn;
    private var fullText:String;
    
    public function HeaderRenderer(column:DataGridToolTipColumn) {
        this.column = column;
    }
